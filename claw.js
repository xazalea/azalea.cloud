define(["exports"], (function(t) {
    ...
    class F {
        ...
        async getDb() {
            return this._ || (this._ = await function(t, e, {blocked: s, upgrade: n, blocking: r, terminated: i}={}) {
    ...
    class H {
        ...
        async delete() {
            this.T = !1,
            await this.M.expireEntries(1 / 0)
        }
    }
    try {
    ...
    class tt {
        ...
        precache(t) {
            ...
            this.G || (self.addEventListener("install", this.install),
